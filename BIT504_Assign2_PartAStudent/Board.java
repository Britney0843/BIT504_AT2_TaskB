...
public class Board {
	...
	public Board() {
		...
		cells = new Cell[GameMain.ROWS][GameMain.COLS]; // initialise the cell array using the GameMain.Row and GameMain.Cols
	...
	public boolean hasWon(Player thePlayer, int playerRow, int playerCol) {
		...
		if(cells[0][playerCol].content == thePlayer && cells[1][playerCol].content == thePlayer && cells[2][playerCol].content == thePlayer )
		 ...
		 // Hint: Use the row code above as a starting point, remember that it goes cells[row][column] // done i think
		...
		if( cells[2][0].content == thePlayer && cells[1][1].content == thePlayer && cells[0][2].content == thePlayer ) // checks diagonal 
			return true;
		// TODO: Check the diagonal in the other direction // done i think
