...
public class GameMain extends JPanel implements MouseListener{
	...
	public static final String TITLE = "Tic Tac Toe"; // create title for JPanel
	...
	public GameMain() {   
		...
		setPreferredSize(new Dimension(CANVAS_WIDTH, CANVAS_HEIGHT + 30));
		 ...
		 //Board board = Class.Board().newInstance();
		
		 Board board = new Board();
		// TODO: Create a new instance of the game "Board"class. HINT check the variables above for the correct name //done i think

		  this.board = board;
		//TODO: call the method to initialise the game board // done i think ??
	...
	javax.swing.SwingUtilities.invokeLater(new Runnable() {
         public void run() {
			...
			frame.add(GameMainpanel); // think this adds gamemain panel to frame
			frame.pack();             
			frame.setLocationRelativeTo(null);
			frame.setVisible(true);
			frame.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE); // default close operation exit_on_close
         }
	 });
}
	...
	public void paintComponent(Graphics g) {
		...
		if(currentState == GameState.Playing) {          
			...
			if (currentPlayer == Player.Cross) {   
				...
				statusBar.setText("It's X's turns");    
